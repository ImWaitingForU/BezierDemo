...
public class BezierView_ElasticBall extends View {
	...
	public BezierView_ElasticBall(Context context) {
		this(context, null, 0);
	}

	public BezierView_ElasticBall(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BezierView_ElasticBall(Context context, AttributeSet attrs, int defStyleAttr) {
